    ...
    companion object {
        ...
        fun <T : SearchServiceOptions> getService(options: T): SearchService<T> {
            return when (options) {
                ...
                is SearchServiceOptions.NastechOptions -> NastechSearchService
...
sealed class SearchServiceOptions {
    ...
    companion object {
        ...
        val TYPES = mapOf(
            ...
            NastechOptions::class to "Nastech",
            ...
            MetasoOptions::class to "Secret Tower",
