package io.github.nastechresearch.nastech.data.db.fts
...
class MessageFtsManager(private val database: AppDatabase) {
     ...
     * reinserted by the caller (see [io.github.nastechresearch.nastech.data.repository.ConversationRepository.rebuildAllIndexes]).
     */
