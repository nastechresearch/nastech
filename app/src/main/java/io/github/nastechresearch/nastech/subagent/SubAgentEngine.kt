package io.github.nastechresearch.nastech.subagent
...
import io.github.nastechresearch.nastech.data.agentrun.AgentRunKind
import io.github.nastechresearch.nastech.data.agentrun.AgentRunRepository
import io.github.nastechresearch.nastech.data.agentrun.AgentRunStatus
 ...
 * re-implement [io.github.nastechresearch.nastech.data.ai.GenerationHandler] — that path is already
 ...
 * via the standard tool gating in [io.github.nastechresearch.nastech.data.ai.tools.LocalTools] — but the
 * engine-level check is the load-bearing guard since a misconfigured assistant could
 * still try to call us. v1: no recursion.
 *
 * Concurrency caps:
 *  - Per-assistant cap from [io.github.nastechresearch.nastech.data.model.Assistant.maxConcurrentSubAgents]
...
class SubAgentEngine(
     ...
     * [io.github.nastechresearch.nastech.data.agentrun.AgentRunBootRecovery] on next start, so the user
     ...
     * Same lazy-Koin pattern as [io.github.nastechresearch.nastech.workflow.execution.WorkflowEngine.localTools].
