 ...
 * [io.github.nastechresearch.nastech.data.telegram.TelegramBotPreferences] in shape: a single store,
...
class BrowserPreferences(private val context: Context) {
     ...
     * Used by [io.github.nastechresearch.nastech.data.ai.tools.LocalTools.getTools] which is non-suspend
