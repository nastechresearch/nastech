package io.github.nastechresearch.nastech.ui.pages.setting.browser
...
class SettingBrowserViewModel(
    ...
    /** Per-tool enabled map, keyed by [io.github.nastechresearch.nastech.browser.BrowserToolDefaults.ALL_TOOLS]. */
