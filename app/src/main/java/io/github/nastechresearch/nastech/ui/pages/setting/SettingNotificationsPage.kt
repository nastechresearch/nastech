...
import io.github.nastechresearch.nastech.data.notifications.NotificationEntry
import io.github.nastechresearch.nastech.data.notifications.NotificationListenerConfig
                ...
                item(
                    onClick = {
                        context.startActivity(
                            io.github.nastechresearch.nastech.data.ai.tools.local.PermissionHelper
 ...
 *
 * The dialog NEVER lists the nastech package itself or com.android.systemui — both would
