package io.github.nastechresearch.nastech.data.permissions
...
import io.github.nastechresearch.nastech.service.RikkaNotificationListenerService
...
object PermissionInventory {
        ...
        when (perm) {
            Manifest.permission.SYSTEM_ALERT_WINDOW -> {
                ...
                return Row(
                    ...
                    description = "Lets Nastech draw the \"agent is working\" overlay while automation is in progress.",
    ...
    private fun accessibilityServiceRow(context: Context): Row {
        ...
        return Row(
            id = "nastech.SERVICE_ACCESSIBILITY",
    ...
    private fun notificationListenerRow(context: Context): Row {
        ...
        return Row(
            id = "nastech.SERVICE_NOTIFICATION_LISTENER",
    ...
    private val DESCRIPTIONS = mapOf(
        ...
        "com.termux.permission.RUN_COMMAND" to "Lets Nastech start commands inside Termux for the termux_run_command tool.",
    )
