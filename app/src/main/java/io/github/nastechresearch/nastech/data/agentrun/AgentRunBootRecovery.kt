package io.github.nastechresearch.nastech.data.agentrun
 ...
 *
 * Run once per process start from [io.github.nastechresearch.nastech.NastechApp.onCreate], after Koin
...
class AgentRunBootRecovery(
    ...
    companion object {
        const val CHANNEL_ID = "nastech_run_recovery"
