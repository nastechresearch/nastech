...
class ChatGenerationForegroundService : Service() {
    ...
    private fun acquireWakeLock() {
        val lock = wakeLock ?: getSystemService(PowerManager::class.java)
            ?.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "nastech:chat_generation")
            ?.also {
    ...
    companion object {
        private const val ACTION_RECONCILE = "io.github.nastechresearch.nastech.action.RECONCILE_CHAT_GENERATION_FGS"
