...
/**
 * Cold-process fallback. Mirrors [io.github.nastechresearch.nastech.workflow.trigger.TimeCronWorkerHelper]:
...
internal object GeofenceTriggerHelper {
    data class Loaded(
        val entity: io.github.nastechresearch.nastech.workflow.db.WorkflowEntity,
