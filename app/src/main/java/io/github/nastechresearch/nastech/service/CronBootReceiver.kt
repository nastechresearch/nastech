...
class CronBootReceiver : BroadcastReceiver(), KoinComponent {
    ...
    private val telegramPrefs: io.github.nastechresearch.nastech.data.telegram.TelegramBotPreferences by inject()
        ...
        scope.launch {
            try {
                ...
                if (cfg != null && cfg.isUsable) {
                    io.github.nastechresearch.nastech.service.TelegramBotService.start(context)
                    io.github.nastechresearch.nastech.service.TelegramBotHealthWorker.schedule(context)
                }
                ...
                runCatching {
                    io.github.nastechresearch.nastech.workflow.trigger.WorkflowBootDispatcher.onBoot()
                }
            } finally {
                pending.finish()
            }
