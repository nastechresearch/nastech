...
class TriggerRegistry(
    ...
    suspend fun resync(enabled: List<WorkflowDefinition>): Unit = syncMutex.withLock {
        ...
        val foregroundConsumerCount = enabled.count { wf ->
            wf.trigger is io.github.nastechresearch.nastech.workflow.model.TriggerSpec.AppLaunched
                || wf.trigger is io.github.nastechresearch.nastech.workflow.model.TriggerSpec.AppClosed
                || wf.conditions.any {
                    it is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.ForegroundAppIs
                        || it is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.ForegroundAppIn
                }
        }
        io.github.nastechresearch.nastech.workflow.trigger.AppForegroundDispatcher
