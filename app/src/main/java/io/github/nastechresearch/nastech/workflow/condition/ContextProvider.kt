package io.github.nastechresearch.nastech.workflow.condition
...
import io.github.nastechresearch.nastech.workflow.model.WorkflowContext
...
class ContextProvider(private val context: Context) {
    ...
    fun snapshot(needsLocation: Boolean = false): WorkflowContext {
        ...
        val foregroundPackage = io.github.nastechresearch.nastech.workflow.trigger.AppForegroundLastKnown.value
