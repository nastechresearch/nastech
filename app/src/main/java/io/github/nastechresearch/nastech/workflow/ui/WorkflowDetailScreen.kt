...
private fun conditionLine(c: io.github.nastechresearch.nastech.workflow.model.ConditionSpec): String {
    val base = when (c) {
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.TimeBetween -> "between ${c.start} and ${c.end}"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.TimeAfterSunset -> "after sunset" +
            if (c.offsetMinutes != 0) " (${c.offsetMinutes}m offset)" else ""
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.TimeBeforeSunrise -> "before sunrise" +
            if (c.offsetMinutes != 0) " (${c.offsetMinutes}m offset)" else ""
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.DayOfWeekIn -> "day(s) ${c.days.joinToString(",")}"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.WifiSsidIs -> "WiFi is ${c.ssid}"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.WifiSsidIn -> "WiFi in ${c.ssids.joinToString(",")}"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.BatteryAbove -> "battery > ${c.percent}%"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.BatteryBelow -> "battery < ${c.percent}%"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.IsCharging -> "charging"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.IsNotCharging -> "not charging"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.ForegroundAppIs -> "foreground app = ${c.packageName}"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.ForegroundAppIn -> "foreground in ${c.packageNames.size} pkgs"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.ScreenIsOn -> "screen on"
        is io.github.nastechresearch.nastech.workflow.model.ConditionSpec.ScreenIsOff -> "screen off"
    }
