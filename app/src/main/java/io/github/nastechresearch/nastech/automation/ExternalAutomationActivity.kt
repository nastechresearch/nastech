 ...
 *
 *  * `io.github.nastechresearch.nastech.RUN_TASK` — fire-and-forget headless run. Activity finishes
 ...
 *  * `io.github.nastechresearch.nastech.RUN_CHAT` — interactive open-the-chat. Reserved; returns
