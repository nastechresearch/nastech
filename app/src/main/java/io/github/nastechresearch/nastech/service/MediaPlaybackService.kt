...
class MediaPlaybackService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "nastech_media_playback"
        const val NOTIFICATION_ID = 7001

        const val ACTION_PLAY = "io.github.nastechresearch.nastech.media.ACTION_PLAY"
        const val ACTION_PAUSE = "io.github.nastechresearch.nastech.media.ACTION_PAUSE"
        const val ACTION_STOP = "io.github.nastechresearch.nastech.media.ACTION_STOP"
        const val ACTION_SEEK = "io.github.nastechresearch.nastech.media.ACTION_SEEK"
    ...
    private fun initMediaSession() {
        ...
        mediaSession = MediaSessionCompat(this, "NastechMediaSession").apply {
