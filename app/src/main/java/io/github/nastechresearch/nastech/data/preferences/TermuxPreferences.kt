 ...
 * Termux timeouts). Mirrors [io.github.nastechresearch.nastech.browser.BrowserPreferences] in shape.
 *
...
class TermuxPreferences(private val context: Context) {
    ...
    init {
        ...
        io.github.nastechresearch.nastech.data.ai.tools.local.TermuxIntegration.restoreVerifiedAt(initial.lastVerifiedMs)
        ...
        io.github.nastechresearch.nastech.data.ai.tools.local.TermuxIntegration.persister = { ms ->
    ...
    /** Blocking variant used by non-suspend callers. See [io.github.nastechresearch.nastech.browser.BrowserPreferences.snapshotBlocking]. */
