package io.github.nastechresearch.nastech.browser

import kotlinx.coroutines.runBlocking
import kotlinx.serialization.json.Json
import me.rerere.ai.ui.UIMessagePart
import io.github.nastechresearch.nastech.data.ai.tools.local.NULL_CONTEXT
import io.github.nastechresearch.nastech.data.ai.tools.local.browserBackTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserClickAndReadTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserClickTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserCurrentUrlTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserDoneTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserEvalJsTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserGetTextTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserOpenTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserPressKeyTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserScrollTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserSelectTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserSubmitTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserTypeTool
import io.github.nastechresearch.nastech.data.ai.tools.local.browserWaitForTool
import io.github.nastechresearch.nastech.data.ai.tools.local.createBrowserTool
