package io.github.nastechresearch.nastech.automation
...
class ExternalAutomationDispatcherTest {
    ...
    @Test fun `action constants match spec strings exactly`() {
        ...
        assertEquals("io.github.nastechresearch.nastech.RUN_TASK", ExternalAutomationDispatcher.ACTION_RUN_TASK)
        assertEquals("io.github.nastechresearch.nastech.RUN_CHAT", ExternalAutomationDispatcher.ACTION_RUN_CHAT)
    }
