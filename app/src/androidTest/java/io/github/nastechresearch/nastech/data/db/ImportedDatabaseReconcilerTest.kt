...
/**
 * Regression test for issues #10 / #11: restoring an *upstream* Nastech 2.4.1 backup into the
...
class ImportedDatabaseReconcilerTest {
    ...
    // Upstream Nastech 2.4.1's actual stamp: user_version 24 plus its own (foreign) identity.
    ...
    /**
     * Writes a file that looks exactly like an upstream Nastech 2.4.1 backup: start from a
