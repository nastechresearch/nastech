...
android {
    namespace = "io.github.nastechresearch.nastech"
    compileSdk = 37
    ...
    defaultConfig {
        ...
        // Supplied only through private Gradle properties or CI secrets; empty disables Gemini OAuth.
        buildConfigField("String", "GEMINI_OAUTH_CLIENT_ID", "\"$geminiOAuthClientId\"")
